...
export async function analyzeWriting(
  ...
  // The DEMO_MODE mock has been intentionally removed in Phase 7 to enforce strict AI evaluation rules.
  // We no longer bypass the AI; every essay must be evaluated to reject nonsense inputs accurately.
